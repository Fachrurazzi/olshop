                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name') }}" placeholder="Product Name" autofocus/>
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <textarea name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" rows="5" placeholder="Product Description">{{ old('description') }}</textarea>
                        ...
                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" id="price" name="price" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" value="{{ old('price') }}" placeholder="Product Price"/>
                            @if ($errors->has('price'))
